...
public:
    IMaterial* CreateMaterial(const char* pMaterialName, KeyValues* pVMTKeyValues)
    {
        ...
        return getvfunc<oCreateMaterial>(this, 84)(this, pMaterialName, pVMTKeyValues);
    }
    ...
    IMaterial* FindMaterial(char const* pMaterialName, const char* pTextureGroupName, bool complain = true, const char* pComplainPrefix = "instux_")
    {
        ...
        return getvfunc<oFindMaterial>(this, 85)(this, pMaterialName, pTextureGroupName, complain, pComplainPrefix);
    }
