...
public:
	void DrawSetColor(int r, int g, int b, int a)
	{
		...
		return getvfunc<oDrawSetColor>(this, 13)(this, r, g, b, a);
	}

	void DrawSetColor(Color color)
	{
		typedef void (* oDrawSetColor)(void*, int, int, int, int);
		return getvfunc<oDrawSetColor>(this, 13)(this, color.r, color.g, color.b, color.a);
	}

	void DrawFilledRect(int x0, int y0, int x1, int y1)
	{
		typedef void (* oDrawFilledRect)(void*, int, int, int, int);
		return getvfunc<oDrawFilledRect>(this, 15)(this, x0, y0, x1, y1);
	}

	void DrawOutlinedRect(int x0, int y0, int x1, int y1)
	{
		typedef void (* oDrawOutlinedRect)(void*, int, int, int, int);
		return getvfunc<oDrawOutlinedRect>(this, 17)(this, x0, y0, x1, y1);
	}
	...
	void DrawPolyLine(int *x, int *y, int count)
	{
		...
		return getvfunc<oDrawPolyLine>(this, 19)(this, x, y, count);
	}

	void DrawSetTextFont(unsigned long font)
	{
		typedef void (* oDrawSetTextFont)(void*, unsigned long);
		return getvfunc<oDrawSetTextFont>(this, 22)(this, font);
	}

	void DrawSetTextColor(int r, int g, int b, int a)
	{
		typedef void (* oDrawSetTextColor)(void*, int, int, int, int);
		return getvfunc<oDrawSetTextColor>(this, 23)(this, r, g, b, a);
	}

	void DrawSetTextColor(Color color)
	{
		typedef void (* oDrawSetTextColor)(void*, int, int, int, int);
		return getvfunc<oDrawSetTextColor>(this, 23)(this, color.r, color.g, color.b, color.a);
	}

	void DrawSetTextPos(int x, int y)
	{
		typedef void (* oDrawSetTextPos)(void*, int, int);
		return getvfunc<oDrawSetTextPos>(this, 25)(this, x, y);
	}

	void DrawPrintText(const wchar_t *text, int textLen)
	{
		typedef void (* oDrawPrintText)(void*, const wchar_t *, int, int);
		return getvfunc<oDrawPrintText>(this, 27)(this, text, textLen, 0);
	}
	...
	void DrawSetTextureRGBA(int textureID, unsigned char const* colors, int w, int h)
	{
		...
		return getvfunc<oDrawSetTextureRGBA>(this, 36)(this, textureID, colors, w, h);
	}

	void DrawSetTexture(int textureID)
	{
		typedef void (* oDrawSetTexture)(void*, int);
		return getvfunc<oDrawSetTexture>(this, 37)(this, textureID);
	}

	int CreateNewTextureID(bool procedural)
	{
		typedef int (* oCreateNewTextureID)(void*, bool);
		return getvfunc<oCreateNewTextureID>(this, 42)(this, procedural);
	}

	HFont CreateFont()
	{
		typedef HFont (* oCreateFont)(void*);
		return getvfunc<oCreateFont>(this, 70)(this);
	}
	...
	void SetFontGlyphSet(unsigned long long &font, const char *FontName, int tall, int weight, int blur, int scanlines, int flags)
	{
		...
		return getvfunc<oSetFontGlyphSet>(this, 71)(this, font, FontName, tall, weight, blur, scanlines, flags, 0, 0);
	}
	...
	void DrawTexturedPolygon(int vtxCount, FontVertex_t *vtx, bool bClipVertices = true)
	{
		...
		return getvfunc<oDrawTexturedPolygon>(this, 105)(this, vtxCount, vtx, bClipVertices);
	}
};
