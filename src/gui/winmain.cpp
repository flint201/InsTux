...
void WinMain::TabAimbotRender()
{
    ...
    ImGui::Text(" ");
    ImGui::SliderFloat("##RECOILX", &Settings::Aimbot::recoilx, 0.f, 2.f, "Recoil cancellation Vertical: %0.2f");
    ImGui::SliderFloat("##RECOILY", &Settings::Aimbot::recoily, 0.f, 2.f, "Recoil cancellation Horizontal: %0.2f");
